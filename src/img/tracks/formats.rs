...
impl ZoneFormat {
    ...
    pub fn apple_525_13(sync_bits: usize) -> Self {
        ...
        Self {
            ...
            gaps: [
                BitVec::from_fn(40*sync_bits, |i| { ((i+1)%sync_bits)%9 > 0 && ((i+1)%sync_bits)%10 > 0}),
                BitVec::from_fn(10*sync_bits, |i| { ((i+1)%sync_bits)%9 > 0 && ((i+1)%sync_bits)%10 > 0}),
                BitVec::from_fn(20*sync_bits, |i| { ((i+1)%sync_bits)%9 > 0 && ((i+1)%sync_bits)%10 > 0}),
            ],
    ...
    pub fn apple_35(zone: usize,sides: usize,interleave: usize) -> Self {
        ...
        Self {
            ...
            gaps: [
                BitVec::from_fn(36*10, |i| { ((i+1)%10)%9 > 0 && ((i+1)%10)%10 > 0}),
                BitVec::from_fn(6*10, |i| { ((i+1)%10)%9 > 0 && ((i+1)%10)%10 > 0}),
                BitVec::from_fn(36*10, |i| { ((i+1)%10)%9 > 0 && ((i+1)%10)%10 > 0}),
            ],
