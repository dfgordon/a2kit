...
use serde_json;
use std::sync::Arc;
use a2kit::lang::{merlin, normalize_client_uri};
...
pub fn handle_notification(
    ...
    match note.method.as_str() {
        ...
        lsp::notification::DidOpenTextDocument::METHOD => {
            // Create checkpoint and launch analysis thread for this document
            if let Ok(params) = serde_json::from_value::<lsp::DidOpenTextDocumentParams>(note.params) {
                let mut chkpt = merlin::checkpoint::CheckpointManager::new();
