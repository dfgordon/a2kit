//! ### ProDOS boot block.
//! 
//! Unlike DOS or CP/M, the OS does not occupy reserved tracks.  Instead
//! there is a system file with an ordinary directory entry that is invoked
//! by the boot block, if it is present.
//! 
//! Data is adapted from that used by CiderPress

pub const FLOPPY_BLOCK0: [u8;512] = [
