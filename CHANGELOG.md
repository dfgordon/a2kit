...
* more robust record length detection
...
* ProDOS smart copy handles custom file types as `any` rather than aborting
* more robust handling of CP/M user prefix and related matters
