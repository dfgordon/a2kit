...
complete -c a2kit -n "__fish_a2kit_needs_command" -f -a "mget" -d 'read list of paths from stdin, get files from disk image, write file images to stdout'
complete -c a2kit -n "__fish_a2kit_needs_command" -f -a "mput" -d 'read list of file images from stdin, restore files to a disk image'
complete -c a2kit -n "__fish_a2kit_needs_command" -f -a "pack" -d 'pack data into a file image'
complete -c a2kit -n "__fish_a2kit_needs_command" -f -a "unpack" -d 'unpack data from a file image'
...
complete -c a2kit -n "__fish_a2kit_needs_command" -f -a "verify" -d 'read from stdin and perform language analysis'
...
complete -c a2kit -n "__fish_a2kit_using_subcommand catalog" -s d -l dimg -d 'path to disk image itself' -r -F
...
complete -c a2kit -n "__fish_a2kit_using_subcommand cat" -s d -l dimg -d 'path to disk image itself' -r -F
...
complete -c a2kit -n "__fish_a2kit_using_subcommand dir" -s d -l dimg -d 'path to disk image itself' -r -F
...
complete -c a2kit -n "__fish_a2kit_using_subcommand ls" -s d -l dimg -d 'path to disk image itself' -r -F
...
complete -c a2kit -n "__fish_a2kit_using_subcommand tree" -s d -l dimg -d 'path to disk image itself' -r -F
complete -c a2kit -n "__fish_a2kit_using_subcommand tree" -l indent -d 'JSON indentation, omit to minify' -r
...
complete -c a2kit -n "__fish_a2kit_using_subcommand stat" -s d -l dimg -d 'path to disk image itself' -r -F
complete -c a2kit -n "__fish_a2kit_using_subcommand stat" -l indent -d 'JSON indentation, omit to minify' -r
complete -c a2kit -n "__fish_a2kit_using_subcommand stat" -s h -l help -d 'Print help'
complete -c a2kit -n "__fish_a2kit_using_subcommand geometry" -s d -l dimg -d 'path to disk image itself' -r -F
complete -c a2kit -n "__fish_a2kit_using_subcommand geometry" -l indent -d 'JSON indentation, omit to minify' -r
...
complete -c a2kit -n "__fish_a2kit_using_subcommand glob" -s d -l dimg -d 'path to disk image itself' -r -F
complete -c a2kit -n "__fish_a2kit_using_subcommand glob" -s f -l file -d 'glob pattern to match against' -r
complete -c a2kit -n "__fish_a2kit_using_subcommand glob" -l indent -d 'JSON indentation, omit to minify' -r
complete -c a2kit -n "__fish_a2kit_using_subcommand glob" -s h -l help -d 'Print help'
complete -c a2kit -n "__fish_a2kit_using_subcommand help; and not __fish_seen_subcommand_from get put mget mput pack unpack mkdsk mkdir delete protect unprotect lock unlock rename retype verify minify renumber catalog tree stat geometry tokenize detokenize asm dasm glob help" -f -a "get" -d 'read from stdin, local, or disk image, write to stdout'
complete -c a2kit -n "__fish_a2kit_using_subcommand help; and not __fish_seen_subcommand_from get put mget mput pack unpack mkdsk mkdir delete protect unprotect lock unlock rename retype verify minify renumber catalog tree stat geometry tokenize detokenize asm dasm glob help" -f -a "put" -d 'read from stdin, write to local or disk image'
complete -c a2kit -n "__fish_a2kit_using_subcommand help; and not __fish_seen_subcommand_from get put mget mput pack unpack mkdsk mkdir delete protect unprotect lock unlock rename retype verify minify renumber catalog tree stat geometry tokenize detokenize asm dasm glob help" -f -a "mget" -d 'read list of paths from stdin, get files from disk image, write file images to stdout'
complete -c a2kit -n "__fish_a2kit_using_subcommand help; and not __fish_seen_subcommand_from get put mget mput pack unpack mkdsk mkdir delete protect unprotect lock unlock rename retype verify minify renumber catalog tree stat geometry tokenize detokenize asm dasm glob help" -f -a "mput" -d 'read list of file images from stdin, restore files to a disk image'
complete -c a2kit -n "__fish_a2kit_using_subcommand help; and not __fish_seen_subcommand_from get put mget mput pack unpack mkdsk mkdir delete protect unprotect lock unlock rename retype verify minify renumber catalog tree stat geometry tokenize detokenize asm dasm glob help" -f -a "pack" -d 'pack data into a file image'
complete -c a2kit -n "__fish_a2kit_using_subcommand help; and not __fish_seen_subcommand_from get put mget mput pack unpack mkdsk mkdir delete protect unprotect lock unlock rename retype verify minify renumber catalog tree stat geometry tokenize detokenize asm dasm glob help" -f -a "unpack" -d 'unpack data from a file image'
complete -c a2kit -n "__fish_a2kit_using_subcommand help; and not __fish_seen_subcommand_from get put mget mput pack unpack mkdsk mkdir delete protect unprotect lock unlock rename retype verify minify renumber catalog tree stat geometry tokenize detokenize asm dasm glob help" -f -a "mkdsk" -d 'write a blank disk image to the given path'
complete -c a2kit -n "__fish_a2kit_using_subcommand help; and not __fish_seen_subcommand_from get put mget mput pack unpack mkdsk mkdir delete protect unprotect lock unlock rename retype verify minify renumber catalog tree stat geometry tokenize detokenize asm dasm glob help" -f -a "mkdir" -d 'create a new directory inside a disk image'
complete -c a2kit -n "__fish_a2kit_using_subcommand help; and not __fish_seen_subcommand_from get put mget mput pack unpack mkdsk mkdir delete protect unprotect lock unlock rename retype verify minify renumber catalog tree stat geometry tokenize detokenize asm dasm glob help" -f -a "delete" -d 'delete a file or directory inside a disk image'
complete -c a2kit -n "__fish_a2kit_using_subcommand help; and not __fish_seen_subcommand_from get put mget mput pack unpack mkdsk mkdir delete protect unprotect lock unlock rename retype verify minify renumber catalog tree stat geometry tokenize detokenize asm dasm glob help" -f -a "protect" -d 'password protect a disk or file'
complete -c a2kit -n "__fish_a2kit_using_subcommand help; and not __fish_seen_subcommand_from get put mget mput pack unpack mkdsk mkdir delete protect unprotect lock unlock rename retype verify minify renumber catalog tree stat geometry tokenize detokenize asm dasm glob help" -f -a "unprotect" -d 'remove password protection from a disk or file'
complete -c a2kit -n "__fish_a2kit_using_subcommand help; and not __fish_seen_subcommand_from get put mget mput pack unpack mkdsk mkdir delete protect unprotect lock unlock rename retype verify minify renumber catalog tree stat geometry tokenize detokenize asm dasm glob help" -f -a "lock" -d 'write protect a file or directory inside a disk image'
complete -c a2kit -n "__fish_a2kit_using_subcommand help; and not __fish_seen_subcommand_from get put mget mput pack unpack mkdsk mkdir delete protect unprotect lock unlock rename retype verify minify renumber catalog tree stat geometry tokenize detokenize asm dasm glob help" -f -a "unlock" -d 'remove write protection from a file or directory inside a disk image'
complete -c a2kit -n "__fish_a2kit_using_subcommand help; and not __fish_seen_subcommand_from get put mget mput pack unpack mkdsk mkdir delete protect unprotect lock unlock rename retype verify minify renumber catalog tree stat geometry tokenize detokenize asm dasm glob help" -f -a "rename" -d 'rename a file or directory inside a disk image'
complete -c a2kit -n "__fish_a2kit_using_subcommand help; and not __fish_seen_subcommand_from get put mget mput pack unpack mkdsk mkdir delete protect unprotect lock unlock rename retype verify minify renumber catalog tree stat geometry tokenize detokenize asm dasm glob help" -f -a "retype" -d 'change file type inside a disk image'
complete -c a2kit -n "__fish_a2kit_using_subcommand help; and not __fish_seen_subcommand_from get put mget mput pack unpack mkdsk mkdir delete protect unprotect lock unlock rename retype verify minify renumber catalog tree stat geometry tokenize detokenize asm dasm glob help" -f -a "verify" -d 'read from stdin and perform language analysis'
complete -c a2kit -n "__fish_a2kit_using_subcommand help; and not __fish_seen_subcommand_from get put mget mput pack unpack mkdsk mkdir delete protect unprotect lock unlock rename retype verify minify renumber catalog tree stat geometry tokenize detokenize asm dasm glob help" -f -a "minify" -d 'reduce program size'
complete -c a2kit -n "__fish_a2kit_using_subcommand help; and not __fish_seen_subcommand_from get put mget mput pack unpack mkdsk mkdir delete protect unprotect lock unlock rename retype verify minify renumber catalog tree stat geometry tokenize detokenize asm dasm glob help" -f -a "renumber" -d 'renumber BASIC program lines'
complete -c a2kit -n "__fish_a2kit_using_subcommand help; and not __fish_seen_subcommand_from get put mget mput pack unpack mkdsk mkdir delete protect unprotect lock unlock rename retype verify minify renumber catalog tree stat geometry tokenize detokenize asm dasm glob help" -f -a "catalog" -d 'write disk image catalog to stdout'
complete -c a2kit -n "__fish_a2kit_using_subcommand help; and not __fish_seen_subcommand_from get put mget mput pack unpack mkdsk mkdir delete protect unprotect lock unlock rename retype verify minify renumber catalog tree stat geometry tokenize detokenize asm dasm glob help" -f -a "tree" -d 'write directory tree as a JSON string to stdout'
complete -c a2kit -n "__fish_a2kit_using_subcommand help; and not __fish_seen_subcommand_from get put mget mput pack unpack mkdsk mkdir delete protect unprotect lock unlock rename retype verify minify renumber catalog tree stat geometry tokenize detokenize asm dasm glob help" -f -a "stat" -d 'write FS statistics as a JSON string to stdout'
complete -c a2kit -n "__fish_a2kit_using_subcommand help; and not __fish_seen_subcommand_from get put mget mput pack unpack mkdsk mkdir delete protect unprotect lock unlock rename retype verify minify renumber catalog tree stat geometry tokenize detokenize asm dasm glob help" -f -a "geometry" -d 'write disk geometry as a JSON string to stdout'
complete -c a2kit -n "__fish_a2kit_using_subcommand help; and not __fish_seen_subcommand_from get put mget mput pack unpack mkdsk mkdir delete protect unprotect lock unlock rename retype verify minify renumber catalog tree stat geometry tokenize detokenize asm dasm glob help" -f -a "tokenize" -d 'read from stdin, tokenize, write to stdout'
complete -c a2kit -n "__fish_a2kit_using_subcommand help; and not __fish_seen_subcommand_from get put mget mput pack unpack mkdsk mkdir delete protect unprotect lock unlock rename retype verify minify renumber catalog tree stat geometry tokenize detokenize asm dasm glob help" -f -a "detokenize" -d 'read from stdin, detokenize, write to stdout'
complete -c a2kit -n "__fish_a2kit_using_subcommand help; and not __fish_seen_subcommand_from get put mget mput pack unpack mkdsk mkdir delete protect unprotect lock unlock rename retype verify minify renumber catalog tree stat geometry tokenize detokenize asm dasm glob help" -f -a "asm" -d 'read from stdin, assemble, write to stdout'
complete -c a2kit -n "__fish_a2kit_using_subcommand help; and not __fish_seen_subcommand_from get put mget mput pack unpack mkdsk mkdir delete protect unprotect lock unlock rename retype verify minify renumber catalog tree stat geometry tokenize detokenize asm dasm glob help" -f -a "dasm" -d 'read from stdin, disassemble, write to stdout'
complete -c a2kit -n "__fish_a2kit_using_subcommand help; and not __fish_seen_subcommand_from get put mget mput pack unpack mkdsk mkdir delete protect unprotect lock unlock rename retype verify minify renumber catalog tree stat geometry tokenize detokenize asm dasm glob help" -f -a "glob" -d 'write JSON list of matching paths to stdout'
complete -c a2kit -n "__fish_a2kit_using_subcommand help; and not __fish_seen_subcommand_from get put mget mput pack unpack mkdsk mkdir delete protect unprotect lock unlock rename retype verify minify renumber catalog tree stat geometry tokenize detokenize asm dasm glob help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
