_a2kit() {
    ...
    do
        case "${cmd},${i}" in
            ...
            a2kit,verify)
                ...
                ;;
            a2kit__help,asm)
                cmd="a2kit__help__asm"
                ;;
            a2kit__help,catalog)
                cmd="a2kit__help__catalog"
                ;;
            a2kit__help,dasm)
                cmd="a2kit__help__dasm"
                ;;
            a2kit__help,delete)
    ...
    case "${cmd}" in
        ...
        a2kit__asm)
            ...
            case "${prev}" in
                --assembler)
                    COMPREPLY=($(compgen -W "m8 m16 m16+ m32" -- "${cur}"))
                    return 0
                    ;;
                -a)
                    COMPREPLY=($(compgen -W "m8 m16 m16+ m32" -- "${cur}"))
            ...
            ;;
        a2kit__catalog)
            opts="-f -d -h --file --generic --dimg --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        a2kit__dasm)
            ...
            case "${prev}" in
                --proc)
                    COMPREPLY=($(compgen -W "6502 65c02 65802 65816" -- "${cur}"))
                    return 0
                    ;;
                -p)
                    COMPREPLY=($(compgen -W "6502 65c02 65802 65816" -- "${cur}"))
                    ...
                    ;;
                --mx)
                    COMPREPLY=($(compgen -W "00 01 10 11" -- "${cur}"))
                    return 0
                    ;;
                --org)
                    COMPREPLY=($(compgen -f "${cur}"))
        ...
        a2kit__rename)
            ...
            ;;
        a2kit__renumber)
            opts="-t -b -e -f -s -r -h --type --beg --end --first --step --reorder --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
            case "${prev}" in
                --type)
                    COMPREPLY=($(compgen -W "atxt itxt" -- "${cur}"))
                    return 0
                    ;;
                -t)
                    COMPREPLY=($(compgen -W "atxt itxt" -- "${cur}"))
        ...
        a2kit__unprotect)
            ...
            ;;
        a2kit__verify)
            opts="-t -s -c -w -h --type --sexpr --config --workspace --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
...
if [[ "${BASH_VERSINFO[0]}" -eq 4 && "${BASH_VERSINFO[1]}" -ge 4 || "${BASH_VERSINFO[0]}" -gt 4 ]]; then
    ...
    complete -F _a2kit -o bashdefault -o default a2kit
fi
